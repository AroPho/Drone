...
double controlInputRight; // controls tilt which in turns overpowers two of the motors
  double controlInputLeft;// Can either increase/decrease motors or rotate drone
  double gyroX;
  double gyroY;
  double gyroZ;
  double recieveTran;
